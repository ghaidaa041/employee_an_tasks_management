...
<aside>
  ...
  <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z"/>
            ...
            <main>
                <div class="continar">
                <form action="./update_emp_to_db.php" method='POST'>
                ...
                if (isset($_POST['edit_btn'])) {
                  ...
                  $qury = "select * from employee where id='$id'";
        ...
        <input type="text" name="edit_emp_name" value = "<?php echo $row['emp_name']?>"><br>
        <label for="">اسم المستخدم</label><br>
        <input type="text" name="edit_emp_user_name" value = "<?php echo $row['emp_user_name']?>"><br>
        <label for="">كلمة المرور</label><br>
        <input type="text" name="edit_emp_password" value = "<?php echo $row['emp_password']?>"><br><br>

        <br> <br>
        <a href="./all_emp.php" class="btn btn-danger">ألغاء</a>
        <button type="submit" name ="update-emp" class="btn2">تعديل</button><br><br>
        <?php
